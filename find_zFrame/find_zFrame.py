...
class find_zFrameWidget(ScriptedLoadableModuleWidget):
  ...
  def setup(self):
    ...
    self.t1TypRadio =  qt.QRadioButton("T1")
    self.ctTypRadio =  qt.QRadioButton("CT")
    self.t1TypRadio.setChecked(True)
    self.ctTypRadio.setChecked(False)
    self.imgTypeHBox.addWidget(self.t1TypRadio)
    self.imgTypeHBox.addWidget(self.ctTypRadio)
    parametersFormLayout.addRow("Image modality: ", self.imgTypeHBox)
    ...
    self.t1TypRadio.connect('toggled(bool)', self.ont1TypeToggle)
  ...
  def ont1TypeToggle(self, checked):
      if checked: self.imgType = 'T1'
  ...
  def onApplyButton(self):
    ...
    logic.run(self.inputSelector.currentNode(), self.outputSelector.currentNode(), self.imgType)
...
class find_zFrameLogic(ScriptedLoadableModuleLogic):
  ...
  def run(self, inputVolume, outputVolume, imgType):
    """
    ...
    import segmentZframe
    segmentZframe.segment_zFrame_slicer(inputVolume, outputVolume, imgType)
